...
import com.example.renteasytrial1st.R;
...
public class payment_mod extends AppCompatActivity implements PaymentStatusListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_payment_mod);    initViews();
